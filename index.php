                ...
                <div style="display:none" id="portfolioFormdialog" class="black_option">
                    ...
                    <div class="portfolio_form">
                        ...
                        <form>
                            ...
                            <p><label>Instrument Coad:</label><input type="text" class="input-text" name="shareSymbol" id="shareSymbol"></p>
                            <p><label>Date:</label><input type="text" class="input-text" id="buyShareDate" name="buyShareDate"></p>
                            ...
                            <p><input type="button" value="Add to Distribution Without Execution" id="buyShare"><input type="button" value="Cancel"></p>
