           ...
           context :    document.body
            ...
            $("#grid").igGrid({
                ...
                columns: [
                    ...
                    { headerText: "%", key: "checkpercentage", dataType: "number", width: "10%", template: "{{if ${checkpercentage} >= 0 }}<label class='upgreen'> ${checkpercentage} </label> {{else}} <label class='downred'> ${checkpercentage} </label> {{/if}}" },
