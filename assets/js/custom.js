...
var showData = (function(data) {
    ...
    if (datagthp.scanning.length == 0) {
        $("#chartlistdialog .noDataFoundForChartList1").remove();
        $("#chartlistdialog .ui-iggrid-table:first").parent().append("<table class='noDataFoundForChartList1'><tr><td style='color:red;font-weight:bold'> No Data Found </td></tr></table>");
    }
    ...
    $("#perfrmSymbolGrid").igGrid({
        ...
        columns: [{
            ...
            headerText: "Triggered Date Share Price",
            key: "selected_trade_close",
            dataType: "string",
            width: "30%"
        }, {
            headerText: "%(respect of triggered date)",
            key: "perfget_percent",
            dataType: "string",
            width: "30%"
        }, ],
...
$('#stockcalculate').click(function() {
    ...
    $.get('stockListTrade.php', {
        selectedDate: chartDateSelect,
        selectedTable: stocktablechoose
    }).done(function(data) {
        console.log(data);
        ...
        $.ajax({
            ...
            $("#grid").igGrid({
                ...
                columns: [{
                        ...
                        dataType: "number",
                        width: "10%",
                        template: "{{if ${checkpercentage} >= 0 }}<label class='upgreen'> ${checkpercentage} </label> {{else}} <label class='downred'> ${checkpercentage} </label> {{/if}}"
                    }, {
                        headerText: "+ / -",
                        key: "checkvalue",
                        dataType: "string",
...
/*var handlerWatchList = function (event, args) {
    console.log(event);
}*/
/************************************************************************************************************
        watchlistspopfunc
...
$(document).ready(function() {
    // Set Date picker for my profile

    // $(function() {
    //     $( "#buyShareDate" ).datepicker();
    // });
    ...
    $('#buyShareDate').datepicker('setDate', settoday);

    // Save My portfolio form data
    $("#buyShare").click(function() {
        $("#portfolioMsg").html('Please Wait. Submitting Form.');
        var shareSymbol = $('#shareSymbol').val();
        var buyDate = $('#buyShareDate').val();
        ...
        $.ajax({
            ...
            console.log(data);
            getDataAndDisplayInEquityPositionsOpen();
            $("#portfolioMsg").html('New Data Has been added.');
        }).error(function(data) {
            $("#portfolioMsg").html('Something went wrong! Please try again later.');
        });
    });
    ...
    $(".equity_open").igGrid({
        ...
        columns: [{
            ...
            headerText: "Weighting in Sector",
            key: "perfget_percent",
            dataType: "string",
            width: "30%"
        }, {
            headerText: "Weighting Cash + Portfoliio Net",
            key: "perfget_percent",
            dataType: "string",
            width: "30%"
        }, {
            headerText: "Weighting Portfolio Net",
            key: "perfget_percent",
            dataType: "string",
            width: "30%"
        }, {
    ...
    $(".sold_open").igGrid({
        ...
        columns: [{
            ...
            headerText: "Call Strike Cap Nett",
            key: "perfget_percent",
            dataType: "string",
            width: "30%"
        }, {
            headerText: "Original Investme nt +/- Inc costs",
            key: "perfget_percent",
            dataType: "string",
            width: "30%"
        }, {
            headerText: "Gain + / - if Exercised",
            key: "perfget_percent",
            dataType: "string",
            width: "30%"
        }, {
            headerText: "% + / - if Exercised",
            key: "perfget_percent",
            dataType: "string",
            width: "30%"
        }, {
    ...
    $(".equity_closed").igGrid({
        ...
        columns: [{
            ...
            headerText: "Investme nt Value at sale",
            key: "perfget_percent",
            dataType: "string",
            width: "30%"
        }, {
            headerText: "Brokerage Buy",
            key: "perfget_percent",
            dataType: "string",
            width: "30%"
        }, {
            headerText: "Brokerage Sell",
            key: "perfget_percent",
            dataType: "string",
            width: "30%"
        }, {
    ...
    $(".option_positionsC").igGrid({
        ...
        columns: [{
            ...
            headerText: "Option Income",
            key: "perfget_percent",
            dataType: "string",
            width: "30%"
        }, {
            headerText: "Expired Value",
            key: "perfget_percent",
            dataType: "string",
            width: "30%"
        }, {
            ...
            headerText: "ACH Fees Sell",
            key: "ACH_Fees_Sell",
            dataType: "string",
            width: "30%"
        }, {
            headerText: "ACH Fees Buy",
            key: "ACH_Fees_Buy",
            dataType: "string",
            width: "30%"
        }, {
