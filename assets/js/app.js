...
var igFinance = (function() {
    var helpers = (function() {
        ...
        function _itemscan(item) {
            ...
            //console.log(typeof window.scanResultDates);
            //console.log(window.scanResultDates.indexOf(item.Date));
            //console.log(window.scanResultDates);
            /*for (var i = 0; i < window.scanResultDates.length; i++) {
                //console.log(window.scanResultDates);
                if (window.scanResultDates[i] == item.Date) {
                    x = "X";
                }
            };*/
        ...
        return {
                ...
                return {
                    ...
                    windowRectChanged: function(evt, ui) {
                        ...
                        if (window.react) {
                            ...
                            closeHigharr = closeHigharr.sort(function(a, b) {
                                return b - a
                            });
                            closeMinarr = closeMinarr.sort(function(a, b) {
                                return a - b
                            });
                            ...
                            $("#priceChart").igDataChart("option", "axes", [{
                                name: "yAxis",
                                type: "numericY",
                                maximumValue: closeHigh,
                                minimumValue: closeMin
                            }]);
                        }
                    },
            ...
            _getIndicatorComboDataSource: function() {
                return [{
                    ...
                    text: resources.IndicatorType.AvgTrueRange
                }, {
                    type: "averageDirectionalIndexIndicator",
                    text: resources.IndicatorType.AvgIndex
                }, {
                    type: "commodityChannelIndexIndicator",
                    text: resources.IndicatorType.CommodityIndex
                }, {
                    type: "fastStochasticOscillatorIndicator",
                    text: resources.IndicatorType.FastOscillator
                }, {
                    type: "forceIndexIndicator",
                    text: resources.IndicatorType.ForceIndex
                }, {
                    type: "moneyFlowIndexIndicator",
                    text: resources.IndicatorType.MoneyFlow
                }, {
                    type: "priceChannelOverlay",
                    text: resources.IndicatorType.PriceOverlay
                }, {
                    type: "rateOfChangeAndMomentumIndicator",
                    text: resources.IndicatorType.RateMomentum
                }, {
                    type: "relativeStrengthIndexIndicator",
                    text: resources.IndicatorType.RelativeIndex
                }, {
                    type: "slowStochasticOscillatorIndicator",
                    text: resources.IndicatorType.SlowOscillator
                }, {
                    type: "stochRSIIndicator",
                    text: resources.IndicatorType.StockRsi
                }, {
                    type: "trixIndicator",
                    text: resources.IndicatorType.Trix
                }, {
                    type: "williamsPercentRIndicator",
                    text: resources.IndicatorType.WilliamsR
                }];
            },
    ...
    return {
        init: function() {
            ...
            $.get('stockScan.php', {
                symbolname: window.selectedSymbol
            }).done(function(data) {
                //console.log("returnData :: " + returnData);
                var returnData = JSON.parse(data);
                //console.log("message :: " + returnData.message)
                if (returnData.success == true) {
                    //window.scanResultDates = $.map(returnData.message, function(el) { return el; }); 
                    window.scanResultDates = returnData.message;
                    //console.log(window.scanResultDates);
                }
